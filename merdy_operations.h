...
typedef msgpack::type::tuple<int,std::string,value_vclock, address> put_dy;
typedef msgpack::type::tuple<int,std::string> ok_put_dy;
typedef msgpack::type::tuple<int,std::string> get_dy;
typedef msgpack::type::tuple<int,std::string,std::string> set_dy;
typedef msgpack::type::tuple<int,std::string,address> ok_set_dy;
typedef msgpack::type::tuple<int,std::string,address> send_dy;
typedef msgpack::type::tuple<int,std::string,std::string,address> set_coordinate;
typedef msgpack::type::tuple<int,std::string,value_vclock,address> found_dy;
typedef msgpack::type::tuple<int,std::string,address> notfound_dy;
